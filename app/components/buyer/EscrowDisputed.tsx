  ...
  return (
    <section className="border border-orange-900 rounded bg-zinc-900 p-4 mb-4">
      <div className="flex items-center justify-between mb-3">
        <p className="text-xs text-zinc-500 uppercase tracking-widest">Issue Reported</p>
      ...
      <div className="border border-zinc-800 rounded bg-zinc-950 p-3 mb-3 flex flex-col gap-1.5 text-xs font-mono">
        <KV k="Order" v={dealId} />
        <KV k="To" v={`${recipient.slice(0, 14)}...${recipient.slice(-6)}`} />
      ...
      <div className="border border-orange-900 rounded bg-zinc-950 p-3 mb-3">
        <p className="text-xs font-mono text-orange-600 mb-1">Issue:</p>
      ...
      <div className="flex items-center gap-2 text-xs font-mono text-zinc-600">
        ...
        Waiting for dispute resolver to review...
      </div>
    </section>
  );
}
