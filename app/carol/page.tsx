...
export default function CarolPage() {
  const { balance } = usePartyUtxos("carol");
  const adaBalance = (balance / 1000000).toFixed(2);
  const address = "addr_test1vrf9ksqwtvkyzgld4uh377prmzlsgyvmsvp9xe56tr3kk8g5g2z0x";
        ...
        <header className="bg-white rounded-lg border border-[#e2e8f0] shadow-sm p-8 mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-2xl font-bold text-[#1e293b]">Carol</h1>
              <span className="text-xs font-bold uppercase tracking-wider text-[#64748b] px-2 py-1 rounded bg-[#f1f5f9] border border-[#e2e8f0]">Mediator</span>
            </div>
